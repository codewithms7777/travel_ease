    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-main">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-value total-amount">₹<?php echo number_format($stat_data['total_success_amount'] ?? 0, 0); ?></div>
                ...
                <div class="stat-card">
                    <div class="stat-value"><?php echo $stat_data['failed_count'] ?? 0; ?></div>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <?php if($payment['payment_status'] == 'success'): ?>
                                            <a href="manage-payments.php?refund=<?php echo $payment['id']; ?>" class="btn-sm btn-warning" onclick="return confirm('Are you sure you want to refund this payment?')">
