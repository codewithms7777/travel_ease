...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO bookings (user_id, booking_type, booking_reference, item_id, details, travel_date, check_in_date, check_out_date, quantity, total_amount, status, payment_status) 
            VALUES ('$user_id', '$type', '$booking_ref', '$item_id', '$details', '$travel_date', " . 
            ($check_in ? "'$check_in'" : "NULL") . ", " . ($check_out ? "'$check_out'" : "NULL") . ", '$quantity', '$total_amount', 'pending', 'pending')";
