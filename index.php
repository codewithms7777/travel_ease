    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="nav-brand">
                ...
                <span>Travel<span class="brand-highlight">Ease</span></span></a>
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="holidaybook.php" id="nav-holiday-packages"> Holiday Packages</a></li>
            ...
            <div class="destination-card" data-destination="Paris">
                <div class="destination-image">
                    ...
                    <div class="destination-overlay">
                        ...
                        <div class="destination-price">
                            <span class="old-price">₹26,999</span>
        ...
        <li><a href="holidaybook.php">Holiday Packages</a></li> <!-- CHANGED -->
                ...
                <div class="footer-section" id="footer-contact">
                    ...
                    <ul class="contact-info">
                        ...
                        <li><i class="fas fa-phone"></i>+91 72018 07642</li>
                        <li><i class="fas fa-phone"></i>+91 70439 58364</li>
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 TravelEase. All rights reserved. | <a href="#">Privacy Policy</a> | <a href="#">Terms & Conditions</a></p>
            </div>
        </div>
    </footer>
